...
public class KinectAudioTracker : MonoBehaviour
{
	...
	private Windows.Kinect.AudioBeamFrameReader audioReader = null;
...
//        }
    ...
    private void Reader_FrameArrived(object sender, Windows.Kinect.AudioBeamFrameArrivedEventArgs e)
    {
        ProcessAudioFrame();
    }
